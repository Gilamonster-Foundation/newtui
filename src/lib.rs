...
pub use widget::{
    bar, butterfly, core_grid, diff, diff_with_sources, gauge, heat_meter, sparkline, ContextRun,
    CoreSeries, DiffData, DiffGeometry, DiffProjection, DiffSide, DiffSourceSpan, NoticeVisibility,
    Run, SparkDirection, Tone, WidgetLine, WidgetNotice, WidgetNoticeKind, WidgetOutput,
    WidgetOutputError,
};
