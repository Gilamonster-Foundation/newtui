...
pub use widget::{
    bar, butterfly, butterfly_history, core_grid, declared_glyph_or_replacement, diff, diff_layout,
    diff_with_sources, gauge, heat_meter, sparkline, ContextRun, CoreSeries, DiffData,
    DiffFileError, DiffGeometry, DiffLayout, DiffLayoutRow, DiffProjection, DiffSide,
    DiffSourceSpan, DiffTarget, NoticeVisibility, Run, SparkDirection, Tone, WidgetContentState,
    WidgetLine, WidgetNotice, WidgetNoticeKind, WidgetOutput, WidgetOutputError,
};
